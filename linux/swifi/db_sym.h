...
unsigned long find_faulty_instr_range(uintptr_t start, uintptr_t end,
				uintptr_t off, int type, int *instr_len, int verbose);
...
#define  KMEM_CACHE_ALLOC	4
#define  KMEM_CACHE_FREE	5
...
#define  MUTEX_UNLOCK	10
#define  SPIN_UNLOCK	11
#define  READ_UNLOCK	12
#define  WRITE_UNLOCK	13
